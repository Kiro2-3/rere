...
$mail->Body .= "\n\nThank you for shopping with us!";
    ...
    $stmt = $conn->prepare('INSERT INTO orders (id,name,email,phone,address,pmode,products,amount_paid)VALUES(?,?,?,?,?,?,?,?)');
    $stmt->bind_param('isssssss', $loggedInUserId, $name, $email, $phone, $address, $pmode, $products, $grand_total);
    $stmt->execute();
