...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['pmode']) && !empty($_POST['pmode'])) {
        $selectedPaymentMethod = $_POST['pmode'];

        // Echo a message based on the selected payment method
        if ($selectedPaymentMethod === 'GCASH') {
            echo "Please send the money to this GCASH number: 09609418285 along with the receipt.";
        } else {
            echo "Thank you for choosing $selectedPaymentMethod as your payment method.";
        }
    } else {
